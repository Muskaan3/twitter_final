...
while True:
    user = api.get_user('Muskaan_323')
    api.update_profile(name=f'Muskaan|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Muskaan|{follower_count(user)} Followers')
